"""Django settings for the trade platform backend."""
...
ROOT_URLCONF = "trade_platfrom.urls"
...
WSGI_APPLICATION = "trade_platfrom.wsgi.application"
...
AUTHENTICATION_BACKENDS = ["user.authentication.EmailOrUsernameBackend"]
...
# Exempt API endpoints from CSRF in development
